  ...
  return (
    <footer className="relative py-12">
      <div className="container mx-auto">
        ...
        <div className="mt-12 pt-8 border-t-4 border-gray-800 flex flex-row justify-between items-center">
          ...
          <motion.button
            onClick={scrollToTop}
            className="mt-0 p-2 border-2 border-gray-800 bg-white hover:bg-gray-200 transition-colors"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
